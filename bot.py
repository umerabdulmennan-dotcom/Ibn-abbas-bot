...
2. AI Q&A about Islam (using FREE Google Gemini API - no credit card needed)
...
GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY")        # from aistudio.google.com (free)
...
def ask_gemini(question: str) -> str:
    """Send a question to Gemini and return the Amharic answer."""
    try:
